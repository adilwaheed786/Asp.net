<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangedPassword.aspx.cs" Inherits="Password_Reset.Registration.ChangedPassword" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1>Welcome USer YOu Can Password Here    </h1>
        </div>
