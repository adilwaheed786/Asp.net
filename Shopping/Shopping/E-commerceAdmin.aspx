<%@ Page Title="" Language="C#" MasterPageFile="~/Shooping.Master" AutoEventWireup="true" CodeBehind="E-commerceAdmin.aspx.cs" Inherits="Shopping.E_commerceAdmin" %>
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*Please Fill" ControlToValidate="txt2" Display="Dynamic" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>                                                                                                 
                        ...
                        <div class="row">
                             <div class="form-group col-md-12">
                                <asp:Button class="btn btn-warning btn-block btn-mg letter" ID="Button3" runat="server" Text="Add Category" Font-Bold="True" />
